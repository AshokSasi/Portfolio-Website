  ...
  return (
    <div >
      ...
      <div className="m-20 text-m/6" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh'}}>
        <p>Hi, Im Ashok — a passionate Full Stack Software Developer with a focus on building clean, efficient, and user-friendly applications. I specialize in full-stack development, front-end design and backend systems, and I love turning ideas into reality through code.
